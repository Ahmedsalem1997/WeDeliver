  ...
  return (
    <>
      ...
      <section className="text-gray-600 body-font">
        ...
        <hr />
        <div className="container px-32 pt-4 pb-10 mx-auto flex flex-wrap">
          <div className="flex">
          ...
          <div className="flex flex-col w-full my-5 justify-between">
            <h1 className="sm:text-3xl text-xl font-medium title-font text-gray-800 lg:w-1/3 lg:mb-0 mb-8">
              Description
            </h1>
          ...
          <div className="flex flex-col w-full my-5 justify-between">
            <h1 className="text-xl font-medium title-font text-gray-800 lg:w-1/3 lg:mb-0 mb-8">
              Features
            </h1>
