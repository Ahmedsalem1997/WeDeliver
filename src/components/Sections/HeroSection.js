    ...
    <div className="bg-hero">
      ...
      <div className="container mx-auto px-16 hero-backg">
        <div className="flex flex-col lg:w-1/2">
          <h2 className="text-white text-xl font-bold text-center mt-16 lg:text-4xl lg:text-left leading-10">
        ...
        <div className="lg:flex space-x-10 p-12 lg:mt-4 bg-blurBg bg-blured rounded my-16">
